...
AnnotationAwareAspectJAutoProxyCreator实现了BeanPostProcessors，在bean对象创建的时候，会调用此对象的postProcessAfterInitialization做拦截处理。父类的方法`org.springframework.aop.framework.autopr